...
import com.edevaldojr.cursomc.domain.Endereco;
...
import com.edevaldojr.cursomc.domain.PagamentoComBoleto;
import com.edevaldojr.cursomc.domain.PagamentoComCartao;
import com.edevaldojr.cursomc.domain.Pedido;
import com.edevaldojr.cursomc.domain.Produto;
import com.edevaldojr.cursomc.domain.enums.TipoCliente;
import com.edevaldojr.cursomc.domain.enums.EstadoPagamento;
import com.edevaldojr.cursomc.domain.enums.Perfil;
import com.edevaldojr.cursomc.repositories.CategoriaRepository;
import com.edevaldojr.cursomc.repositories.CidadeRepository;
import com.edevaldojr.cursomc.repositories.ClienteRepository;
import com.edevaldojr.cursomc.repositories.EnderecoRepository;
import com.edevaldojr.cursomc.repositories.EstadoRepository;
import com.edevaldojr.cursomc.repositories.ItemPedidoRepository;
import com.edevaldojr.cursomc.repositories.PagamentoRepository;
import com.edevaldojr.cursomc.repositories.PedidoRepository;
import com.edevaldojr.cursomc.repositories.ProdutoRepository;
...
public class DBService {
        ...
        public void instantiateTesteDatabase() throws ParseException {
                ...
                Cliente cli1 = new Cliente(null, "Maria Silva", "ed.tadsifpr@gmail.com", "36678912377",
                                TipoCliente.PESSOAFISICA, pe.encode("123"));
                cli1.getTelefones().addAll(Arrays.asList("36678912377", "93838393"));

                Cliente cli2 = new Cliente(null, "Ana Costa", "e.j.2001@hotmail.com", "59349568098",
                                TipoCliente.PESSOAFISICA, pe.encode("123"));
                cli2.addPerfil(Perfil.ADMIN);
                cli2.getTelefones().addAll(Arrays.asList("92929292911", "92900292911"));
